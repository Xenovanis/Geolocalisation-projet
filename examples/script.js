...
var map = new L.Map('map', {
  ...
  var Pointsofstopping = [[34.050499, -6.813492],[34.059783, -6.802546], [34.063972, -6.808971],[34.061447, -6.812482],[34.059344, -6.817213],[34.053808, -6.822638], [34.046701, -6.828114], [34.041947, -6.820833],[34.050499, -6.813492]];
  map.fitBounds(Pointsofstopping);
 
  var durations = [10000, 8000,7000,7000,7000,8000,8000,9000];
  ...
  marker1.on('end', function () {
      marker1.bindPopup('<b>Click me to start again !</b>', {closeOnClick: false}).openPopup();
  });
